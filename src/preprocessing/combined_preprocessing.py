...
class CombinedPreprocessor:
    ...
    def preprocess_dataset(self,
                          ...
                          save_dir: str,
                          save_format: str = "npz",
                          batch_size: int = 32) -> Tuple[MultimodalDataset, Dict]:
        """
        ...
        self.save_combined_dataset(text_features, image_features, np.array(labels), combined_save_path)
    ...
    @staticmethod
    def load_combined_dataset(load_path: str) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """
    ...
    def create_data_splits(self,
                          ...
                          save_format: str = "npz",
                          random_seed: int = 42) -> Dict[str, MultimodalDataset]:
        """
        ...
        splits = {
            ...
            'val': (texts[train_end:val_end], image_paths[train_end:val_end], labels[train_end:val_end]),
        ...
        for split_name, (split_texts, split_images, split_labels) in splits.items():
            ...
            dataset, metadata = self.preprocess_dataset(
                split_texts, split_images, split_labels,
                save_dir=split_dir,
...
def preprocess_twitter_dataset(data_path: str,
                              image_dir: str,
                              save_dir: str = "./processed_data/twitter",
                              save_format: str = "npz") -> Dict[str, MultimodalDataset]:
    """
...
def preprocess_weibo_dataset(data_path: str,
                            image_dir: str,
...
def create_dataloaders(datasets: Dict[str, MultimodalDataset],
                      batch_size: int = 64,
...
if __name__ == "__main__":
    ...
    loaded_text, loaded_image, loaded_labels = CombinedPreprocessor.load_combined_dataset(
