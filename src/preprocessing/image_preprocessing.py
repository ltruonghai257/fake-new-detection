...
class ImagePreprocessor:
    ...
    def preprocess_dataset(
        self, image_paths: List[str], labels: List[int], save_path: Optional[str] = None
...
def preprocess_twitter_images(
    ...
    features, labels_array = preprocessor.preprocess_dataset(
        image_paths, labels, save_path=f"{save_dir}/image_features.{save_format}"
    )

    return features, labels_array


def preprocess_weibo_images(
    data_path: str,
    image_dir: str,
...
def create_augmented_image_features(
    image_paths: List[str], augmentations: int = 3
) -> np.ndarray:
    """
...
if __name__ == "__main__":
    ...
    sample_image_paths = ["./sample_images/image1.jpg", "./sample_images/image2.jpg"]
    ...
    features, labels = preprocessor.preprocess_dataset(
        sample_image_paths, sample_labels, save_path="./sample_image_data.pkl"
    )
